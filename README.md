...
## 프로젝트 설명
지문은 일생 동안 변하지 않으므로 유출되었을 때 치명적입니다. 동형암호란 복호화를 하지 않은 암호화 상태에서 연산을 진행하는 것을 말합니다.
...
LightPHE와 지문인식 알고리즘을 결합한 후, SAD 알고리즘으로 복호화 없이 계산해 보안성이 뛰어난 지문인식 프로그램을 제작했습니다.
